    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            ...
            <div class="p-4 collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav menu">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">Boutique</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">Exos</a>

                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="#">01_exo_variables</a></li>
                            <li><a class="dropdown-item" href="#">02_exo_array</a></li>
                            <li><a class="dropdown-item" href="#">03_exo_boucles</a></li>
                            <li><a class="dropdown-item" href="#">01_exo_form</a></li>
                            <li><a class="dropdown-item" href="#">02_traitement_form</a></li>
                            <li><a class="dropdown-item" href="#">03_exo_get</a></li>
